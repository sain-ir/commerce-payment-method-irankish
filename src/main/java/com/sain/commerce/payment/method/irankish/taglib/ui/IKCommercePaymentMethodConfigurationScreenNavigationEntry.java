...
package com.sain.commerce.payment.method.irankish.taglib.ui;
...
//import com.liferay.commerce.payment.method.mercanet.internal.configuration.IKGroupServiceConfiguration;
...
import com.sain.commerce.payment.method.irankish.IKCommercePaymentMethod;
...
public class IKCommercePaymentMethodConfigurationScreenNavigationEntry
	...
	public boolean isVisible(
		...
		if (IKCommercePaymentMethod.KEY.equals(
	...
	public void render(
		...
		try {
			IKGroupServiceConfiguration authorizeNetGroupServiceConfiguration =
						...
						new ParameterMapSettingsLocator(
							...
							new GroupServiceSettingsLocator(
								_portal.getScopeGroupId(httpServletRequest),
									IKCommercePaymentMethodConstants.
									SERVICE_NAME)));

			httpServletRequest.setAttribute(
				IKGroupServiceConfiguration.class.getName(),
